...
class Error_Of_Trail:
    ...
    def reinitialize_parameters(self, error_type=None, error_value=None, error_position=None,
                                length_parameter=None, resist_per_meter=None, induct_per_meter=None,
                                capacit_per_meter=None, conduct_per_meter=None):
        """
    ...
    def call_matrix_main(self):
        ...
        # 使用实例变量中的电压值作为结果
        voltage_results = {
            "send_end_track_voltage": float(self.output_voltage_surface1.real),
            "receive_end_track_voltage": float(self.output_voltage_surface2.real),
            "main_track_input_voltage": float(self.output_voltage_main.real)
        }
...
if __name__ == "__main__":
    # 创建一个无故障的实例
    error_instance = Error_Of_Trail(trail="test", error_type=0, error_value=0, error_position="69G")
    ...
    # 创建一个有故障的实例
    error_instance_fault = Error_Of_Trail(trail="test", error_type=1, error_value=1, error_position="69G")
