...
class Error_Of_Trail:
    def __init__(self,trail,error_type,error_value,error_position,length_parameter):
        self.trail=trail
...
if __name__ == "__main__":
    # 创建一个无故障的实例
    error_instance = Error_Of_Trail(trail="test", error_type=0, error_value=0, error_position="69G",length_parameter=100.0)
    ...
    # 创建一个有故障的实例
    error_instance_fault = Error_Of_Trail(trail="test", error_type=1, error_value=1, error_position="69G",length_parameter=100.0)
